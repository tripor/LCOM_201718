...
/**
 * @brief Obtem informação
 *
 * @param mode mode de funcionamento da grafica
 * @param vmi_p struct onde vou guardar informacao
 * @return returna 0 caso não ocorra nenhum erro ou 1 caso contrario
 */
int vbe_get_mode_info(unsigned short mode, vbe_mode_info_t * vmi_p);
/**
 * @brief sair do modo grafico
 *
 * @return returna 0 caso não ocorra nenhum erro ou 1 caso contrario
 */
int vg_exit();
/**
 * @brief inicializa o endereco do modo grafico
 *
 */
void *vg_init();
